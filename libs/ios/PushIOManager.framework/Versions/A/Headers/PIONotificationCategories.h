...
<key>orcl_rsys_rate</key><array><dict><key>identifier</key><string>rate</string><key>title</key><string>RATE</string><key>authorizationRequired</key><false/><key>destructive</key><false/><key>foreground</key><true/></dict></array></dict></plist>";
